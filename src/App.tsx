function App() {
  return (
    <div className="font-sans h-screen w-screen flex-wrap overflow-y-auto flex flex-row bg-[url('https://images.unsplash.com/photo-1553877522-43269d4ea984?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]">
      <div className="h-1/4 md:h-full flex md:flex-col flex-col justify-center items-center gap-0 w-full">
        <h1 className="font-sans font-semibold text-7xl md:text-8xl text-primary">
          PROJECT: VA;
        </h1>
        <h2 className="font-sans font-semibold text-lg md:text-xl text-primary">
      ...
      <div className="h-1/3 w-full gap-5 flex flex-col md:overflow-none overflow-y-auto flex-wrap text-primary p-5 justify-center items-center">
        <div className="text-secondary bg-primary/70 md:w-1/2 lg:w-1/3 xl:w-1/4 w-full h-full rounded-lg p-5 text-center">
          <div className="text-3xl lg:text-2xl">Property Management</div>
          <div className="text-xl lg:text-lg indent-5 mt-5">
        ...
        <div className="text-secondary bg-primary/70 md:w-1/2 lg:w-1/3 xl:w-1/4 w-full h-full rounded-lg p-5 text-center">
          <div className="text-3xl lg:text-2xl">Bookkeeping</div>
          <div className="text-xl lg:text-lg indent-5 mt-5">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab quod,
            voluptatibus ad quo aut quam aliquid atque harum sunt similique
            labore unde quae quis exercitationem facilis voluptas quia
        ...
        <div className="text-secondary bg-primary/70 md:w-1/2 lg:w-1/3 xl:w-1/4 w-full h-full rounded-lg p-5 text-center">
          <div className="text-3xl lg:text-2xl">Graphic Design</div>
          <div className="text-xl lg:text-lg indent-5 mt-5">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab quod,
            voluptatibus ad quo aut quam aliquid atque harum sunt similique
            labore unde quae quis exercitationem facilis voluptas quia
      ...
      <div className="w-full h-1/4 flex justify-center items-center">
        <button className="rounded-md bg-primary/90 p-5 text-white font-semibold">
          BOOK A CONSULTATION
        </button>
      </div>
